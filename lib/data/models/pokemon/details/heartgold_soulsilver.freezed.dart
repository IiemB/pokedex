...
/// @nodoc
abstract class _$$_HeartgoldSoulsilverCopyWith<$Res>
    implements $HeartgoldSoulsilverCopyWith<$Res> {
  factory _$$_HeartgoldSoulsilverCopyWith(_$_HeartgoldSoulsilver value,
          $Res Function(_$_HeartgoldSoulsilver) then) =
      __$$_HeartgoldSoulsilverCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'back_default') String? backDefault,
...
/// @nodoc
class __$$_HeartgoldSoulsilverCopyWithImpl<$Res>
    extends _$HeartgoldSoulsilverCopyWithImpl<$Res, _$_HeartgoldSoulsilver>
    implements _$$_HeartgoldSoulsilverCopyWith<$Res> {
  __$$_HeartgoldSoulsilverCopyWithImpl(_$_HeartgoldSoulsilver _value,
      $Res Function(_$_HeartgoldSoulsilver) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_HeartgoldSoulsilver(
      backDefault: freezed == backDefault
          ? _value.backDefault
          : backDefault // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_HeartgoldSoulsilver implements _HeartgoldSoulsilver {
  _$_HeartgoldSoulsilver(
  ...
  factory _$_HeartgoldSoulsilver.fromJson(Map<String, dynamic> json) =>
      _$$_HeartgoldSoulsilverFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_HeartgoldSoulsilver &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_HeartgoldSoulsilverCopyWith<_$_HeartgoldSoulsilver> get copyWith =>
      __$$_HeartgoldSoulsilverCopyWithImpl<_$_HeartgoldSoulsilver>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_HeartgoldSoulsilverToJson(
      this,
    );
  }
}
...
abstract class _HeartgoldSoulsilver implements HeartgoldSoulsilver {
  factory _HeartgoldSoulsilver(
      ...
      @JsonKey(name: 'front_shiny')
          final String? frontShiny,
      @JsonKey(name: 'front_shiny_female')
          final String? frontShinyFemale}) = _$_HeartgoldSoulsilver;

  factory _HeartgoldSoulsilver.fromJson(Map<String, dynamic> json) =
      _$_HeartgoldSoulsilver.fromJson;
